...
if __name__ == '__main__':
    ...
    a.send('ethtool -s enp1s0 autoneg off speed 1000 duplex full')
    a.wait('e1000e 0000:01:00.0 enp1s0: NIC Link is Up 1000 Mbps Full Duplex, Flow Control: Rx/Tx',10)
