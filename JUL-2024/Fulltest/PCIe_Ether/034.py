...
if __name__ == '__main__':
    ...
    a.buff=""
    a.send('user {} {}'.format(config.SER_USRNAME,config.SER_PASS),0,False,1200,'ftp')
    ...
    a.buff=""  
    a.send('get /home/{}/test_pcie/file-{}m file-{}m'.format(config.SER_USRNAME,SIZE,SIZE),0,True,1200,'ftp')
