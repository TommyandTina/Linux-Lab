...
if __name__ == '__main__':
    ...
    a.send('ethtool -s enp1s0 autoneg off speed 100 duplex half', 0, False)
    a.wait('e1000e 0000:01:00.0 enp1s0: NIC Link is Up 100 Mbps Half Duplex, Flow Control: None',10)

    a.buff=""
    a.send('ethtool enp1s0')

    if (a.buff.find('Speed: 100Mb/s')==-1) \
