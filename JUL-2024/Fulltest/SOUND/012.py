...
RECORD_OPTION = '-D plughw:0,0 -f s24_le -t wav -c 2 -r 192000 -d 300 '
PLAYBACK_OPTION = '-D plughw:0,0 -f s24_le -t wav -c 2 -r 192000'
...
if __name__ == '__main__':
    ...
    if (config.SOC.find('E3') != -1):
        a.send('mount -t tmpfs -o size=1G tmpfs /tmp')
