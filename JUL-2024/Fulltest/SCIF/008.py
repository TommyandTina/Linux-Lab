...
if __name__ == '__main__':
    ...
    print('\n\n---------- HOST-PC -----------')
    print('\nstty -F {} speed 115200 oddp cs8 -cstopb'.format(config.SERIAL_PORT))
    sys.stdout.flush()
    os.system('stty -F {} speed 115200 oddp cs8 -cstopb'.format(config.SERIAL_PORT))
    os.system('stty -F {} speed 115200 cs8 -cstopb'.format(config.SERIAL_PORT))
    ...
    print('\n\n---------- HOST-PC -----------')
    print('\necho "abcd" > {}'.format(config.SERIAL_PORT))
    sys.stdout.flush()
