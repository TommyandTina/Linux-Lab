...
def execute_test(TC):
    ...
    try:    
        ...
        subprocess.call('python {}.py  2>&1 | tee logs/tmp_{}.log'.format(num_TC(TC),num_TC(TC)),shell=True)
        ...
        subprocess.call('mv logs/tmp_{}.log logs/{}_{}.log'.format(num_TC(TC),num_TC(TC),log_name),shell=True)
...
def boot_board(option):
    ...
    try:
        ...
        name = "boot" 
    os.system('python ../common/restart_board.py  2>&1 | tee logs/{}.log'.format(name)) 
